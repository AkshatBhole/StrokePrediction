...
import pandas as pd
import numpy as np
from joblib import dump # Save the trained model
import matplotlib.pyplot as plt

def load_data():
    df = pd.read_csv(r'E:\StrokePrediction\backend\healthcare-dataset-stroke-data.csv')
...
dump(pipeline, 'stroke_prediction_model.joblib') # Save the transformer for future use